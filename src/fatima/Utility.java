...
public class Utility {
	...
	/**
	 * Liefert eine zufällige Ganzzahl zwischen <code>min</code> und <code>max</code> zurück
	 * 
	 * @param min
	 * @param max
	 * @return
	...
	int getAbgewieseneKunden() {
		System.out.println("Abgewiesene Kunden sind kumulativ zu protokollieren.");
		return 0;
	}
	 ...
	 * 
	 * @param id ein eindeutige Nummer zum Identifizieren der angegebenen Warteschlange
	 * @return
	 */
